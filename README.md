...
```bash
$ (chroot) stat --format="%y" "/boot/initramfs.cpio.gz"
2021-04-10 22:59:16.000000000 +0100
```
...
Please go to [Shrinking the modified image](https://codeberg.org/keks24/raspberry-pi-luks/src/tag/v4.11.1#shrinking-the-modified-image), which was done for `Raspberry Pi OS (Debian 12 Bookworm)`.
...
$ cryptsetup luksUUID --uuid="a00be720-f82f-452c-96cf-669601d1d57e" "/dev/mmcblk0p2"
